...
SKY.CarouselItem.createReflection = function (a, b, c) {
    var d = a.width(),
        g = a.height(),
        e = null;
    SKY.Utils.hasCanvasSupport() ? (e = $("<div>"), ctx = e.get(0).getContext("2d"), e.attr({
        width: d,
        height: b
...
SKY.Carousel.prototype = {
    ...
    createGradientOverlay: function (a, b, c, d, g) {
        if (SKY.Utils.hasCanvasSupport()) {
            var e = $('<div class="sc-overlay" width="' + g + '" height="1"></div'),
...
window.Modernizr = function (a, b, c) {
    ...
    k.canvastext = function () {
        return !!f.canvas && !! d(b.createElement("div").getContext("2d").fillText, "function")
    };
    k.touch = function () {
        var c;
